    ...
    return (
        <div className="flex flex-col items-center mt-10 px-3 ">
            <div className=" flex flex-col pb-12 items-start sm:items-center ">
                <h1 className="leading-normal text-xl sm:text-center lg:text-4xl">A Louisville based <span className="text-accent leading-none inline-block pt-1 text-6xl lg:inline">FullStack Developer</span></h1>
            ...
            <div className="flex justify-center lg:m-8 lg:mb-0 w-full h-full ">
                <img class=" w-11/12 h-auto sm:w-5/6 md:w-9/12 lg:w-5/12 lg:pb-0.5 "src={setup} alt="my setup"></img>
            </div>
        </div>
