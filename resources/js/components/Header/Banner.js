        ...
        <div className="flex flex-col items-center mt-10 px-5 ">
            <div className=" flex flex-col pb-12 items-start sm:items-center ">
                ...
                <div className="mt-4 self-center">
                   <img className=" w-56 h-56  lg:w-64 lg:h-64 rounded-full border-2 border-secondary" src="https://res.cloudinary.com/jlucompany/image/upload/v1589583341/Portfolio/Headshot_wwybb2.jpg" alt="Pic of me"></img>
                </div>
            </div>
