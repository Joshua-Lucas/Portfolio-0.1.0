    ...
    return (
        <div id="about" className="flex flex-col items-center -mt-1 px-5 text-primary bg-accent sm:-mt-2 lg:-mt-1 xl:-mt-3">
           <div className="lg:w-3/5 pt-20 pb-40">
                ...
                <p className="text-center pt-6 leading-normal text-lg md:text-xl  md:px-16 ">When I am not at my computer, you can find me enjoying the outdoors with my wife, trying a new restaurant, or sharing a conversation with a friend over a cup of coffee. </p>
            </div>
        </div>
